...
Како се ово тестира? Добро је одвојити свој „доменски“ код од спољног света \ (нуспојаве \). `fmt.Println` је нежељени ефекат \ (штампање у `stdout` \), а низ који шаљемо је наш домен.
...
Овде уводимо још један алат у наш арсенал тестирања, подтестове. Понекад је корисно груписати тестове око „неке ствари“, а затим имати подтестове који описују различите сценарије.
...
Рефакторинг није само у вези са производним кодом!
