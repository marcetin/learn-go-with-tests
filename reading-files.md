...
Ослањајући се на добром софтверским инжењерским праксама попут [**dependency injection**](dependency-injection.md) Наш код је једноставан за тестирање и поновну употребу.
